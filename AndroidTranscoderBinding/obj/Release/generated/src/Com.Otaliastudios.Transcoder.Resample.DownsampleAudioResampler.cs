...
namespace Com.Otaliastudios.Transcoder.Resample {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.resample']/class[@name='DownsampleAudioResampler']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/resample/DownsampleAudioResampler", DoNotGenerateAcw=true)]
	public partial class DownsampleAudioResampler : global::Java.Lang.Object, global::Com.Otaliastudios.Transcoder.Resample.IAudioResampler {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/resample/DownsampleAudioResampler", typeof (DownsampleAudioResampler));
		...
		protected DownsampleAudioResampler (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.resample']/class[@name='DownsampleAudioResampler']/constructor[@name='DownsampleAudioResampler' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe DownsampleAudioResampler () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Resample.DownsampleAudioResampler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.resample']/class[@name='DownsampleAudioResampler']/method[@name='resample' and count(parameter)=5 and parameter[1][@type='java.nio.ShortBuffer'] and parameter[2][@type='int'] and parameter[3][@type='java.nio.ShortBuffer'] and parameter[4][@type='int'] and parameter[5][@type='int']]"
