...
namespace Com.Otaliastudios.Transcoder.Strategy {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.strategy']/class[@name='RemoveTrackStrategy']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/strategy/RemoveTrackStrategy", DoNotGenerateAcw=true)]
	public partial class RemoveTrackStrategy : global::Java.Lang.Object, global::Com.Otaliastudios.Transcoder.Strategy.ITrackStrategy {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/strategy/RemoveTrackStrategy", typeof (RemoveTrackStrategy));
		...
		protected RemoveTrackStrategy (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.strategy']/class[@name='RemoveTrackStrategy']/constructor[@name='RemoveTrackStrategy' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe RemoveTrackStrategy () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Strategy.RemoveTrackStrategy> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.strategy']/class[@name='RemoveTrackStrategy']/method[@name='createOutputFormat' and count(parameter)=2 and parameter[1][@type='java.util.List&lt;android.media.MediaFormat&gt;'] and parameter[2][@type='android.media.MediaFormat']]"
