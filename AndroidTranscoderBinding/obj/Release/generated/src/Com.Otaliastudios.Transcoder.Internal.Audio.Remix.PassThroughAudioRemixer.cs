...
namespace Com.Otaliastudios.Transcoder.Internal.Audio.Remix {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.internal.audio.remix']/class[@name='PassThroughAudioRemixer']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/internal/audio/remix/PassThroughAudioRemixer", DoNotGenerateAcw=true)]
	public partial class PassThroughAudioRemixer : global::Java.Lang.Object {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/internal/audio/remix/PassThroughAudioRemixer", typeof (PassThroughAudioRemixer));
		...
		protected PassThroughAudioRemixer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.internal.audio.remix']/class[@name='PassThroughAudioRemixer']/constructor[@name='PassThroughAudioRemixer' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PassThroughAudioRemixer () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Internal.Audio.Remix.PassThroughAudioRemixer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.GetRemixedSize (inputSize);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.internal.audio.remix']/class[@name='PassThroughAudioRemixer']/method[@name='getRemixedSize' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.internal.audio.remix']/class[@name='PassThroughAudioRemixer']/method[@name='remix' and count(parameter)=2 and parameter[1][@type='java.nio.ShortBuffer'] and parameter[2][@type='java.nio.ShortBuffer']]"
