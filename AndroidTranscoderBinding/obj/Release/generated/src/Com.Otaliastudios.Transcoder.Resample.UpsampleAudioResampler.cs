...
namespace Com.Otaliastudios.Transcoder.Resample {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.resample']/class[@name='UpsampleAudioResampler']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/resample/UpsampleAudioResampler", DoNotGenerateAcw=true)]
	public partial class UpsampleAudioResampler : global::Java.Lang.Object, global::Com.Otaliastudios.Transcoder.Resample.IAudioResampler {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/resample/UpsampleAudioResampler", typeof (UpsampleAudioResampler));
		...
		protected UpsampleAudioResampler (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.resample']/class[@name='UpsampleAudioResampler']/constructor[@name='UpsampleAudioResampler' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe UpsampleAudioResampler () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Resample.UpsampleAudioResampler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.resample']/class[@name='UpsampleAudioResampler']/method[@name='resample' and count(parameter)=5 and parameter[1][@type='java.nio.ShortBuffer'] and parameter[2][@type='int'] and parameter[3][@type='java.nio.ShortBuffer'] and parameter[4][@type='int'] and parameter[5][@type='int']]"
