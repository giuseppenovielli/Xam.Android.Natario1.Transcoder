...
namespace Com.Otaliastudios.Transcoder.Resample {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.resample']/class[@name='DefaultAudioResampler']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/resample/DefaultAudioResampler", DoNotGenerateAcw=true)]
	public partial class DefaultAudioResampler : global::Java.Lang.Object, global::Com.Otaliastudios.Transcoder.Resample.IAudioResampler {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/resample/DefaultAudioResampler", typeof (DefaultAudioResampler));
		...
		protected DefaultAudioResampler (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.resample']/class[@name='DefaultAudioResampler']/constructor[@name='DefaultAudioResampler' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe DefaultAudioResampler () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Resample.DefaultAudioResampler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.resample']/class[@name='DefaultAudioResampler']/method[@name='resample' and count(parameter)=5 and parameter[1][@type='java.nio.ShortBuffer'] and parameter[2][@type='int'] and parameter[3][@type='java.nio.ShortBuffer'] and parameter[4][@type='int'] and parameter[5][@type='int']]"
