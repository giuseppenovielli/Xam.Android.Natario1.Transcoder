...
namespace Com.Otaliastudios.Transcoder.Resize {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.resize']/class[@name='FractionResizer']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/resize/FractionResizer", DoNotGenerateAcw=true)]
	public partial class FractionResizer : global::Java.Lang.Object, global::Com.Otaliastudios.Transcoder.Resize.IResizer {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/resize/FractionResizer", typeof (FractionResizer));
		...
		protected FractionResizer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.resize']/class[@name='FractionResizer']/constructor[@name='FractionResizer' and count(parameter)=1 and parameter[1][@type='float']]"
		[Register (".ctor", "(F)V", "")]
		public unsafe FractionResizer (float fraction) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Resize.FractionResizer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.resize']/class[@name='FractionResizer']/method[@name='getOutputSize' and count(parameter)=1 and parameter[1][@type='com.otaliastudios.transcoder.common.Size']]"
