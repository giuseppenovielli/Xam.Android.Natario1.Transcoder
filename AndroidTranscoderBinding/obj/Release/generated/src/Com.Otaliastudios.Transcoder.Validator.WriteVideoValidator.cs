...
namespace Com.Otaliastudios.Transcoder.Validator {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.validator']/class[@name='WriteVideoValidator']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/validator/WriteVideoValidator", DoNotGenerateAcw=true)]
	public partial class WriteVideoValidator : global::Java.Lang.Object, global::Com.Otaliastudios.Transcoder.Validator.IValidator {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/validator/WriteVideoValidator", typeof (WriteVideoValidator));
		...
		protected WriteVideoValidator (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.validator']/class[@name='WriteVideoValidator']/constructor[@name='WriteVideoValidator' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe WriteVideoValidator () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Validator.WriteVideoValidator> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.validator']/class[@name='WriteVideoValidator']/method[@name='validate' and count(parameter)=2 and parameter[1][@type='com.otaliastudios.transcoder.common.TrackStatus'] and parameter[2][@type='com.otaliastudios.transcoder.common.TrackStatus']]"
