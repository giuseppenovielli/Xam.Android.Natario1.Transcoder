...
namespace Com.Otaliastudios.Transcoder.Sink {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.sink']/class[@name='MultiDataSink']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/sink/MultiDataSink", DoNotGenerateAcw=true)]
	public partial class MultiDataSink : global::Java.Lang.Object, global::Com.Otaliastudios.Transcoder.Sink.IDataSink {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/sink/MultiDataSink", typeof (MultiDataSink));
		...
		protected MultiDataSink (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.sink']/class[@name='MultiDataSink']/constructor[@name='MultiDataSink' and count(parameter)=1 and parameter[1][@type='com.otaliastudios.transcoder.sink.DataSink...']]"
		[Register (".ctor", "([Lcom/otaliastudios/transcoder/sink/DataSink;)V", "")]
		public unsafe MultiDataSink (params global::Com.Otaliastudios.Transcoder.Sink.IDataSink[] sink) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "([Lcom/otaliastudios/transcoder/sink/DataSink;)V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Sink.MultiDataSink> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Release ();
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.sink']/class[@name='MultiDataSink']/method[@name='release' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.sink']/class[@name='MultiDataSink']/method[@name='setLocation' and count(parameter)=2 and parameter[1][@type='double'] and parameter[2][@type='double']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.sink']/class[@name='MultiDataSink']/method[@name='setOrientation' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.sink']/class[@name='MultiDataSink']/method[@name='setTrackFormat' and count(parameter)=2 and parameter[1][@type='com.otaliastudios.transcoder.common.TrackType'] and parameter[2][@type='android.media.MediaFormat']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.sink']/class[@name='MultiDataSink']/method[@name='setTrackStatus' and count(parameter)=2 and parameter[1][@type='com.otaliastudios.transcoder.common.TrackType'] and parameter[2][@type='com.otaliastudios.transcoder.common.TrackStatus']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.sink']/class[@name='MultiDataSink']/method[@name='stop' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.sink']/class[@name='MultiDataSink']/method[@name='writeTrack' and count(parameter)=3 and parameter[1][@type='com.otaliastudios.transcoder.common.TrackType'] and parameter[2][@type='java.nio.ByteBuffer'] and parameter[3][@type='android.media.MediaCodec.BufferInfo']]"
