...
namespace Com.Otaliastudios.Transcoder.Validator {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.validator']/class[@name='WriteAlwaysValidator']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/validator/WriteAlwaysValidator", DoNotGenerateAcw=true)]
	public partial class WriteAlwaysValidator : global::Java.Lang.Object, global::Com.Otaliastudios.Transcoder.Validator.IValidator {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/validator/WriteAlwaysValidator", typeof (WriteAlwaysValidator));
		...
		protected WriteAlwaysValidator (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.validator']/class[@name='WriteAlwaysValidator']/constructor[@name='WriteAlwaysValidator' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe WriteAlwaysValidator () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Validator.WriteAlwaysValidator> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.validator']/class[@name='WriteAlwaysValidator']/method[@name='validate' and count(parameter)=2 and parameter[1][@type='com.otaliastudios.transcoder.common.TrackStatus'] and parameter[2][@type='com.otaliastudios.transcoder.common.TrackStatus']]"
