...
namespace Com.Otaliastudios.Transcoder.Stretch {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.otaliastudios.transcoder.stretch']/class[@name='CutAudioStretcher']"
	[global::Android.Runtime.Register ("com/otaliastudios/transcoder/stretch/CutAudioStretcher", DoNotGenerateAcw=true)]
	public partial class CutAudioStretcher : global::Java.Lang.Object, global::Com.Otaliastudios.Transcoder.Stretch.IAudioStretcher {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/otaliastudios/transcoder/stretch/CutAudioStretcher", typeof (CutAudioStretcher));
		...
		protected CutAudioStretcher (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.otaliastudios.transcoder.stretch']/class[@name='CutAudioStretcher']/constructor[@name='CutAudioStretcher' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe CutAudioStretcher () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Otaliastudios.Transcoder.Stretch.CutAudioStretcher> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.otaliastudios.transcoder.stretch']/class[@name='CutAudioStretcher']/method[@name='stretch' and count(parameter)=3 and parameter[1][@type='java.nio.ShortBuffer'] and parameter[2][@type='java.nio.ShortBuffer'] and parameter[3][@type='int']]"
